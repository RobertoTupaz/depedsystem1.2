        ...
        <div style="width: 100%; height:830px; border: 0px; margin:0px;">
            <div>
                ...
                <div style="font-size:17px; margin-top:4rem;">
                    <span>Mr./Ms.:</span>
                    <strong><span style="font-size:19px;">{{$full_name}}</span></strong>
                    <br>
                ...
                <p style="font-size:17px; text-indent:4rem; text-align: justify; line-height: 1.5;">
                ...
                <p style="font-size:17px; text-indent: 4rem; text-align: justify; line-height: 1.5;">This salary adjustment is subject to review
